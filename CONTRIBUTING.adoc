...
* Level 3 and above titles and project are listed in alphabetical
order(Except Related Web Sites and Resources, skip symbols)
...
You can turn on a PR to remove a project, but ultimately it’s C-BJ’s
decision
